...
- [x] Build the isolated Red Oni Boss arena with Boss-only Faith Bean shooting, a 60 HP bar, and Phase 1/Phase 2 progression
- [x] Make Phase 1 attack warnings and cooldowns accelerate smoothly as Boss HP approaches 40
